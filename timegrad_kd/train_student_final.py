...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        train_cfg = {
            ...
            # KD/학생 하이퍼
            "n_steps_s": args.n_steps_s,
            "res_channels": args.res_channels,
            "res_blocks": args.res_blocks,
            "lambda_kd": args.lambda_kd,
            "mu_kd": args.mu_kd,
            "gamma_x0": args.gamma_x0,
            "kd_warmup": args.kd_warmup,
            "kd_multi": getattr(args, "kd_multi", 1),
            # EMA
            "ema_mu": 0.999,
            # (선택) 손실 설정(SNR 가중 등) 쓰고 있다면 같이 기록
            # "snr_gamma": 0.5,
        }
        ...
        torch.save({"model": cpu_ema, "D": D, "cfg": stu_cfg, "train_cfg": train_cfg, "role": "student"}, ckpt)
